...
class BasicController:
    ...
    def bind(self, listener: Listener):
        ...
        listener.bind(Action.PageDown, self.key_press(Key.tab))
        listener.bind(Action.PageUp, self.key_press(Key.tab, Key.shift))
        ...
        listener.bind(Action.Exit, self.key_press(Key.esc))
